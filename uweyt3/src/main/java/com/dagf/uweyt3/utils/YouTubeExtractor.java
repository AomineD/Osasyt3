...
public abstract class YouTubeExtractor extends AsyncTask<String, Void, Map<Integer, YtFile>> {
    ...
    private final static String LOG_TAG = "MAIN-Youtube";
   ...
   // private String cacheDirPath;
    ...
    public YouTubeExtractor(Context cacheFolder) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            context = cacheFolder;//cacheFolder.toAbsolutePath().toString();
        }else{
            context = cacheFolder;
        }
    }
    ...
    public void extract(String youtubeLink, boolean parseDashManifest, boolean includeWebM) {
      ...
      //  Log.e("MAIN", "extract: "+youtubeLink );
    }
    ...
    protected Map<Integer, YtFile> doInBackground(String... params) {
        ...
        Log.e("MAIN", "doInBackground: "+ytUrl );
        if (videoID != null) {
            try {
                return getStreamUrls();
            } catch (Exception e) {
                Log.e("MAIN", "ERROR IN : ");//+e.printStackTrace(););
                e.printStackTrace();
            }
        } else {
    ...
    private Map<Integer, YtFile> getStreamUrls() throws IOException, InterruptedException {
        ...
        try {
            Log.e("MAIN", "antes de buffered: "+(urlConnection.getResponseMessage()) );
            reader = new BufferedReader(new InputStreamReader(urlConnection.getInputStream()));
            Log.e("MAIN", "despues de buffered: "+ytInfoUrl );
         //   streamMap = reader.readLine();
            Log.e("MAIN", "getStreamUrls: "+ytInfoUrl );
        }finally{
            if (reader != null) {
                reader.close();
            }
        ...
        for (String encStream : streams) {
            ...
            if (url != null) {
                ...
                Log.e("MAIN", "getStreamUrls: "+newVideo.getUrl() );
    ...
    private void decipherViaWebView(final Map<Integer, String> encSignatures) {
        ...
        stb.append("};decipher();");
         ...
         Log.e("MAIN", "ESTA ENTRANDO EN WEBVIEWSX");
    }
